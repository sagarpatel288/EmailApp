package com.example.android.emailapp.gmail.models;
...
public class Message extends BaseModel {
    ...
    public Message(String threadId, List<String> labels, String snippet, String mimetype, Map<String, String> headers, List<MessagePart> parts, long timestamp, int color, MessagePart parentPart) throws JSONException {
        this.labels = labels;
